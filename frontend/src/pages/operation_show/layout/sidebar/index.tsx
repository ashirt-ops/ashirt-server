...
export default (props: {
  ...
  const moreDetailsModal = useModal<{}>((modalProps) => (
    <OperationBadgesModal
      {...modalProps}
      topContribs={operation.topContribs}
  ...
  return (
    <div className={cx('root')}>
      <header>
        ...
        <Link
          className={cx('edit')}
          to={`/operations/${operation.slug}/edit`}
      ...
      {props.showCreateButtons == 'sidebar-above' && (
        <ButtonGroup className={cx('create-evi-finding-group')}>
          <Button size="medium" onClick={props.onRequestCreateEvidence}>
            Create Evidence
          </Button>
          <Button size="medium" onClick={props.onRequestCreateFinding}>
            Create Finding
          </Button>
        </ButtonGroup>
      )}
    ...
    <>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
        ...
        {props.showCreateButtons === 'sidebar-inline' && (
          <Button small onClick={props.addNew}>
            Add New
          </Button>
        )}
      </div>
