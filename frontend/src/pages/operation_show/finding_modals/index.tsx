...
export const ChangeEvidenceOfFindingModal = (props: {
  ...
  return (
    <ModalForm
      title="Select Evidence For Finding"
      submitText="Save"
      onRequestClose={props.onRequestClose}
      {...formComponentProps}
    >
...
export const RemoveEvidenceFromFindingModal = (props: {
  ...
  return (
    <ModalForm
      title="Remove Evidence From Finding"
      submitText="Remove Evidence"
      onRequestClose={props.onRequestClose}
      {...formComponentProps}
    >
