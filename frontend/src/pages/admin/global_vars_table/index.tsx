...
export default (props: {
  ...
  return (
    <SettingsSection title="Global Variables" width="wide">
          ...
          <>
            {data?.map((globalVar) => (
              <TableRow
                ...
                data={rowBuilder(
                  globalVar,
                  modifyActions(globalVar, setDeletingGlobalVar, setModifyingGlobalVar),
                )}
              />
            ))}
          </>
      ...
      {deletingGlobalVar && (
        <DeleteVarModal
          variableData={{ variable: deletingGlobalVar }}
          onRequestClose={() => {
            setDeletingGlobalVar(null)
            wiredGlobalVars.reload()
          }}
        />
      )}
      {modifyingGlobalVar && (
        <ModifyVarModal
          variableData={{ variable: modifyingGlobalVar }}
          onRequestClose={() => {
            setModifyingGlobalVar(null)
            wiredGlobalVars.reload()
          }}
        />
      )}
...
const TableRow = (props: { data: Rowdata; globalVar: GlobalVar }) => (
  <tr>
