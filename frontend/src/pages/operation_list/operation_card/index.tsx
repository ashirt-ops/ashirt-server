...
export default (props: {
  ...
  const moreDetailsModal = useModal<{}>(modalProps => (
    <OperationBadgesModal {...modalProps} topContribs={props.topContribs} evidenceCount={props.evidenceCount} status={props.status} numTags={props.numTags} />
  ))
  ...
  return (
    <Card className={cx('root', props.className)}>
      ...
      <OperationBadges className={cx('badges')} numUsers={props.numUsers} status={props.status} showDetailsModal={handleDetailsModal} />
