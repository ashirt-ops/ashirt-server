...
export const backendDataSource: DataSource = {
  ...
  listEvidence: (ids, query) =>
    req('GET', `/operations/${ids.operationSlug}/evidence`, null, { query }),
  createEvidence: (ids, formData) =>
    reqMultipart('POST', `/operations/${ids.operationSlug}/evidence`, formData),
  readEvidenceContent: (ids) =>
    reqText('GET', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/media`),
  updateEvidence: (ids, formData) =>
    reqMultipart('PUT', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}`, formData),
  deleteEvidence: (ids, payload) =>
    req('DELETE', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}`, payload),
  getEvidenceMigrationDifference: (ids, fromOperationSlug) =>
    req('GET', `/move/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}`, null, {
      sourceOperationSlug: fromOperationSlug,
    }),
  moveEvidence: (ids, fromOperationSlug) =>
    req('PUT', `/move/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}`, {
      sourceOperationSlug: fromOperationSlug,
    }),
  createEvidenceMetadata: (ids, payload) =>
    req('POST', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/metadata`, payload),
  updateEvidenceMetadata: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/metadata`, payload),
  readEvidenceMetadata: (ids) =>
    req('GET', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/metadata`),
  runServiceWorkerForEvidence: (ids) =>
    req(
      'PUT',
      `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/metadata/${ids.source}/run`,
    ),
  runServiceWorkerBatch: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/metadata/run`, payload),

  runAllServiceWorkersForEvidence: (ids) =>
    req('PUT', `/operations/${ids.operationSlug}/evidence/${ids.evidenceUuid}/metadata/run`),

  listFindingCategories: (includeDeleted) =>
    req('GET', `/findings/categories`, null, { includeDeleted }),
  createFindingCategory: (payload) => req('POST', `/findings/category`, payload),
  deleteFindingCategory: (ids, payload) =>
    req('DELETE', `/findings/category/${ids.findingCategoryId}`, payload),
  updateFindingCategory: (ids, payload) =>
    req('PUT', `/findings/category/${ids.findingCategoryId}`, payload),
  listFindings: (ids, query) =>
    req('GET', `/operations/${ids.operationSlug}/findings`, null, { query }),
  createFinding: (ids, payload) =>
    req('POST', `/operations/${ids.operationSlug}/findings`, payload),
  readFinding: (ids) => req('GET', `/operations/${ids.operationSlug}/findings/${ids.findingUuid}`),
  updateFinding: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/findings/${ids.findingUuid}`, payload),
  deleteFinding: (ids) =>
    req('DELETE', `/operations/${ids.operationSlug}/findings/${ids.findingUuid}`),
  readFindingEvidence: (ids) =>
    req('GET', `/operations/${ids.operationSlug}/findings/${ids.findingUuid}/evidence`),
  updateFindingEvidence: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/findings/${ids.findingUuid}/evidence`, payload),
  ...
  listUserPermissions: (ids, query) =>
    req('GET', `/operations/${ids.operationSlug}/users`, null, query),
  listUserGroupPermissions: (ids, query) =>
    req('GET', `/operations/${ids.operationSlug}/usergroups`, null, query),
  updateUserPermissions: (ids, payload) =>
    req('PATCH', `/operations/${ids.operationSlug}/users`, payload),
  updateUserGroupPermissions: (ids, payload) =>
    req('PATCH', `/operations/${ids.operationSlug}/usergroups`, payload),
  ...
  deleteUserAuthScheme: (ids) =>
    req('DELETE', `/user/${ids.userSlug}/scheme/${ids.authSchemeName}`),
  adminListUsers: (query) => req('GET', '/admin/users', null, query),
  adminCreateHeadlessUser: (payload) => req('POST', '/admin/user/headless', payload),

  listUserGroups: (query, includeDeleted, operationSlug) =>
    req('GET', '/usergroups', null, { query, includeDeleted, operationSlug }),
  ...
  adminModifyUserGroup: (ids, payload) =>
    req('PUT', `/admin/usergroups/${ids.userGroupSlug}`, payload),
  ...
  updateQuery: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/queries/${ids.queryId}`, payload),
  ...
  updateTag: (ids, payload) =>
    req('PUT', `/operations/${ids.operationSlug}/tags/${ids.tagId}`, payload),
  ...
  adminUpdateServiceWorker: (ids, payload) =>
    req('PUT', `/admin/services/${ids.serviceWorkerId}`, payload),
  adminDeleteServiceWorker: (ids) =>
    req('DELETE', `/admin/services/${ids.serviceWorkerId}`, { delete: true }),
  adminUnDeleteServiceWorker: (ids) =>
    req('DELETE', `/admin/services/${ids.serviceWorkerId}`, { delete: false }),
  ...
  createOperationVar: (ids, payload) =>
    req('POST', `/operation-vars/${ids.operationSlug}`, payload),
  updateOperationVar: (ids, payload) =>
    req('PUT', `/operation-vars/${ids.operationSlug}/${ids.varSlug}`, payload),
