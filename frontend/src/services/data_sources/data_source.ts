...
export interface DataSource {
  ...
  deleteEvidence(
    ids: OpSlug & EvidenceUuid,
    payload: { deleteAssociatedFindings: boolean },
  ): Promise<void>
  getEvidenceMigrationDifference(
    ids: OpSlug & EvidenceUuid,
    fromOperationSlug: string,
  ): Promise<dtos.TagDifference>
  ...
  runServiceWorkerBatch(
    ids: OpSlug,
    payload: { workers: Array<string>; evidenceUuids: Array<string> },
  ): Promise<void>
  ...
  updateFinding(
    ids: OpSlug & FindingUuid,
    payload: FindingPayload & { readyToReport: boolean; ticketLink: string | null },
  ): Promise<void>
  ...
  updateFindingEvidence(
    ids: OpSlug & FindingUuid,
    payload: { evidenceToAdd: Array<string>; evidenceToRemove: Array<string> },
  ): Promise<void>
  ...
  listUserGroupPermissions(
    ids: OpSlug,
    query: { name?: string },
  ): Promise<Array<dtos.UserGroupOperationRole>>
  updateUserPermissions(
    ids: OpSlug,
    payload: { userSlug: string; role: types.UserRole },
  ): Promise<void>
  updateUserGroupPermissions(
    ids: OpSlug,
    payload: { userGroupSlug: string; role: types.UserRole },
  ): Promise<void>
  ...
  adminListUsers(query: {
    deleted: boolean
    name?: string
  }): Promise<types.PaginationResult<dtos.UserAdminView>>
  ...
  ): Promise<Array<dtos.UserGroupAdminView>>
  ...
  adminModifyUserGroup(
    ids: UserGroupSlug,
    payload: { newName: string | null; userSlugsToAdd: string[]; userSlugsToRemove: string[] },
  ): Promise<void>

  listQueries(ids: OpSlug): Promise<Array<dtos.Query>>
  createQuery(
    ids: OpSlug,
    payload: { name: string; query: string; type: 'evidence' | 'findings' },
  ): Promise<void>
  upsertQuery(
    ids: OpSlug,
    payload: { name: string; query: string; type: 'evidence' | 'findings'; replaceName?: boolean },
  ): Promise<void>
  ...
  getRecoveryMetrics(): Promise<types.RecoveryMetrics>
  adminChangePassword(i: { userSlug: string; newPassword: string }): Promise<void>
  adminCreateLocalUser(i: {
    firstName: string
    lastName?: string
    email: string
  }): Promise<dtos.NewUserCreatedByAdmin>
  adminInviteUser(i: {
    firstName: string
    lastName?: string
    email: string
  ...
  updateGlobalVar(
    ids: Name,
    payload: { value: string | null; newName: string | null },
  ): Promise<void>
  ...
  createOperationVar(
    ids: OpSlug,
    payload: { varSlug: string; name: string; value: string | null },
  ): Promise<dtos.OperationVar>
  updateOperationVar(
    ids: OpAndVarSlugs,
    payload: { value: string | null; name: string | null },
  ): Promise<void>
