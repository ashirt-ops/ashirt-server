...
func CreateOperation(ctx context.Context, db *database.Connection, i CreateOperationInput) (*dtos.Operation, error) {
	if err := policy.Require(middleware.Policy(ctx), policy.CanCreateOperations{}); err != nil {
		return nil, errors.WrapError("Unable to create operation", errors.UnauthorizedWriteErr(err))
	}
	...
	if i.Slug == "" {
		return nil, errors.MissingValueErr("Slug")
	}
	...
	if err != nil {
		if database.IsAlreadyExistsError(err) {
			return nil, errors.WrapError("Unable to create operation. Operation slug already exists.", errors.BadInputErr(err, "An operation with this slug already exists"))
		}
		return nil, errors.WrapError("Unable to add new operation", errors.DatabaseErr(err))
	}
...
func DeleteOperation(ctx context.Context, db *database.Connection, contentStore contentstore.Store, slug string) error {
	...
	if err != nil {
		return errors.WrapError("Unable to delete operation", errors.UnauthorizedWriteErr(err))
	}

	if err := policyRequireWithAdminBypass(ctx, policy.CanDeleteOperation{OperationID: operation.ID}); err != nil {
		return errors.WrapError("Unwilling to delete operation", errors.UnauthorizedWriteErr(err))
	}
	...
	g.Go(func() error {
		...
		if err != nil {
			...
			return errors.WrapError("Cannot delete operation", errors.DatabaseErr(err))
		}
		return nil
	})
...
func ListOperations(ctx context.Context, db *database.Connection) ([]*dtos.Operation, error) {
	...
	if err != nil {
		return nil, errors.WrapError("Cannot get user operation preferences", errors.DatabaseErr(err))
	}
...
func ReadOperation(ctx context.Context, db *database.Connection, operationSlug string) (*dtos.Operation, error) {
	...
	if err := policyRequireWithAdminBypass(ctx, policy.CanReadOperation{OperationID: operation.ID}); err != nil {
		return nil, errors.WrapError("Unwilling to read operation", errors.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return nil, errors.WrapError("Cannot read operation", errors.DatabaseErr(err))
	}
...
func UpdateOperation(ctx context.Context, db *database.Connection, i UpdateOperationInput) error {
	...
	if err != nil {
		return errors.WrapError("Cannot update operation", errors.DatabaseErr(err))
	}
	return nil
}
...
func ListOperationsForAdmin(ctx context.Context, db *database.Connection) ([]*dtos.Operation, error) {
	if err := isAdmin(ctx); err != nil {
		return nil, errors.UnauthorizedReadErr(err)
	}
...
func listAllOperations(ctx context.Context, db *database.Connection) ([]OperationWithID, error) {
	...
	if err != nil {
		return nil, errors.WrapError("Cannot list all operations", errors.DatabaseErr(err))
	}
...
func SetFavoriteOperation(ctx context.Context, db *database.Connection, i SetFavoriteInput) error {
	...
	if err := policy.Require(middleware.Policy(ctx), policy.CanReadOperation{OperationID: operation.ID}); err != nil {
		return errors.WrapError("Unwilling to read operation", errors.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return errors.WrapError("Cannot set operation as favorite", errors.DatabaseErr(err))
	}
