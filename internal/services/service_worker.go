...
func ListServiceWorker(ctx context.Context, db *database.Connection) ([]*dtos.ServiceWorker, error) {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return nil, errors.WrapError("Insufficient access to view service workers", errors.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return nil, errors.WrapError("Could not list service workers", errors.DatabaseErr(err))
	}
...
func CreateServiceWorker(ctx context.Context, db *database.Connection, i CreateServiceWorkerInput) error {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return errors.WrapError("Insufficient access to create a service worker", errors.UnauthorizedWriteErr(err))
	}
	...
	if err != nil {
		return errors.WrapError("Could not create a service worker", errors.DatabaseErr(err))
	}
...
func UpdateServiceWorker(ctx context.Context, db *database.Connection, i UpdateServiceWorkerInput) error {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return errors.WrapError("Insufficient access to update the service worker", errors.UnauthorizedWriteErr(err))
	}
	...
	if err != nil {
		return errors.WrapError("Could not update the service worker", errors.DatabaseErr(err))
	}
...
func DeleteServiceWorker(ctx context.Context, db *database.Connection, i DeleteServiceWorkerInput) error {
	...
	err := db.Update(query)
	if err != nil {
		return errors.WrapError("Could not delete the service worker", errors.DatabaseErr(err))
	}
...
func RunServiceWorker(ctx context.Context, db *database.Connection, i RunServiceWorkerInput) error {
	...
	if err != nil {
		return errors.WrapError("Unable to run service worker", errors.UnauthorizedWriteErr(err))
	}
...
func BatchRunServiceWorker(ctx context.Context, db *database.Connection, i BatchRunServiceWorkerInput) error {
	...
	if err != nil {
		return errors.WrapError("Unable to run service workers", errors.UnauthorizedWriteErr(err))
	}
...
func TestServiceWorker(ctx context.Context, db *database.Connection, serviceWorkerID int64) (*dtos.ServiceWorkerTestOutput, error) {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return nil, errors.WrapError("Insufficient access to test a service worker", errors.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return nil, errors.WrapError("Unable to find worker", errors.DatabaseErr(err))
	}
