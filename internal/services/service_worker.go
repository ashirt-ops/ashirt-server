...
func ListServiceWorker(ctx context.Context, db *database.Connection) ([]*dtos.ServiceWorker, error) {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return nil, errorwrap.WrapError("Insufficient access to view service workers", errorwrap.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return nil, errorwrap.WrapError("Could not list service workers", errorwrap.DatabaseErr(err))
	}
...
func CreateServiceWorker(ctx context.Context, db *database.Connection, i CreateServiceWorkerInput) error {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return errorwrap.WrapError("Insufficient access to create a service worker", errorwrap.UnauthorizedWriteErr(err))
	}
	...
	if err != nil {
		return errorwrap.WrapError("Could not create a service worker", errorwrap.DatabaseErr(err))
	}
...
func UpdateServiceWorker(ctx context.Context, db *database.Connection, i UpdateServiceWorkerInput) error {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return errorwrap.WrapError("Insufficient access to update the service worker", errorwrap.UnauthorizedWriteErr(err))
	}
	...
	if err != nil {
		return errorwrap.WrapError("Could not update the service worker", errorwrap.DatabaseErr(err))
	}
...
func DeleteServiceWorker(ctx context.Context, db *database.Connection, i DeleteServiceWorkerInput) error {
	...
	err := db.Update(query)
	if err != nil {
		return errorwrap.WrapError("Could not delete the service worker", errorwrap.DatabaseErr(err))
	}
...
func RunServiceWorker(ctx context.Context, db *database.Connection, i RunServiceWorkerInput) error {
	...
	if err != nil {
		return errorwrap.WrapError("Unable to run service worker", errorwrap.UnauthorizedWriteErr(err))
	}
...
func BatchRunServiceWorker(ctx context.Context, db *database.Connection, i BatchRunServiceWorkerInput) error {
	...
	if err != nil {
		return errorwrap.WrapError("Unable to run service workers", errorwrap.UnauthorizedWriteErr(err))
	}
...
func TestServiceWorker(ctx context.Context, db *database.Connection, serviceWorkerID int64) (*dtos.ServiceWorkerTestOutput, error) {
	if err := policy.Require(middleware.Policy(ctx), policy.AdminUsersOnly{}); err != nil {
		return nil, errorwrap.WrapError("Insufficient access to test a service worker", errorwrap.UnauthorizedReadErr(err))
	}
	...
	if err != nil {
		return nil, errorwrap.WrapError("Unable to find worker", errorwrap.DatabaseErr(err))
	}
