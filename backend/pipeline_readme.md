...
There are various options in how you can construct a valid service. The primary concern is how to
safely contact this service. Once contacted, the service is then responsible for the following:
